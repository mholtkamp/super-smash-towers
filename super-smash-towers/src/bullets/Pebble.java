...
public class Pebble extends Bullet
{
	...
	public Pebble(Enemy target, float center_x, float center_y, int damagemultiplier, AssetManager manager)
	{
		...
		tex = new Texture[2];
		tex[0] = manager.get("data/bullets/pebble.png");
		tex[1] = manager.get("data/bullets/pebble.png");
		current_tex = 0;
