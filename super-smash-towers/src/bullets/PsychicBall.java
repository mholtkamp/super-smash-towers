...
public class PsychicBall extends Bullet
{
	...
	public PsychicBall(Enemy target, float center_x, float center_y, int damagemultiplier,AssetManager manager)
	{
		...
		tex[0] = null;
		tex[1] =  null;
		tex[0] = manager.get("data/bullets/fire_ball_1.png");
		tex[1] = manager.get("data/bullets/fire_ball_2.png");
		current_tex = 0;
		tex_count = CALLS_BETWEEN_TOGGLE;
		
		damage = 0*damagemultiplier;
		speed = 10;
...
public class PsychicBall extends Bullet
{
	...
	public PsychicBall(Enemy target, float center_x, float center_y, int damagemultiplier, AssetManager manager)
	{
		...
		// attributes - change for each new Bullet
		tex = new Texture[2];
		tex[0] = manager.get("data/bullets/pball1.png");
		tex[1] = manager.get("data/bullets/pball2.png");
		current_tex = 0;
		tex_count = CALLS_BETWEEN_TOGGLE;
