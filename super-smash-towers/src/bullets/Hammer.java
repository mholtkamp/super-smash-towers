...
public class Hammer extends Bullet
{
	...
	public Hammer(Enemy target, float center_x, float center_y, int damagemultiplier,AssetManager manager)
	{
		...
		tex[0] = manager.get("data/bullets/hammer/hammer_left_up.png");
		tex[1] = manager.get("data/bullets/hammer/hammer_left_left.png");
		tex[2] = manager.get("data/bullets/hammer/hammer_left_down.png");
		tex[3] = manager.get("data/bullets/hammer/hammer_left_right.png");
		current_tex = 0;
