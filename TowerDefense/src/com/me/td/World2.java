...
//	final int BASIC_TOWER = 0, HAMMER_BROS = 1, PSYCHIC_TOWER = 2, FIRE_TOWER = 3;
	...
	final int SELL = 0, UPGRADE = 1, CASTLE = 2, HAMMER = 3, PSYCHIC = 4, FIRE = 5, GRASS = 6, PAUSE = 7;	// TOWERS
...
//	Texture heart0, heart25, heart50, heart75, heart100;
	...
	boolean enable_enemy_spawn, enable_tower_spawn, gameover, timeKeeper, enable_enemy_switch,
		enable_tower_switch, enable_gold, congrats, enable_selling, selling_state, upgrade_state, drawOptionMenu, pause_state;
	long prevTime, time;
...
//			font.setColor(1.0f, 1.0f, 1.0f, 1.0f);
 ...
 public void update()
 {
	 if(mute)
		...
		//update options menu
		//if in pause state want to halt operations.
	if(pause_state)
	{
...
//						towers.add(t);
	...
	private void play_congrats()
	{
		if (!congrats)
		{
			congratulations.play(SOUND_VOLUME);
			congrats = true;
		}
	}
